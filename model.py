...
class Rating(db.Model):
    ...
    #parameter passed to ForeignKey should be string in format >> table.column_name
...
class Movie(db.Model):
    ...
    def __repr__(self):
        """Provide helpful representation when printed"""   
        return "<Movie movie_id={} title={} release_at={} imdb_url={}>".format(self.movie_id, 
            self.title, self.release_at, self.imdb_url)
